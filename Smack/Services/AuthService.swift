...
class AuthService {
    ...
    var authToken: String {
        get {
            guard let key = defaults.value(forKey: TOKEN_KEY) else { return "" }
    ...
    func setUserInfo(data: JSON) {
//        let json = JSON(data: data)
        let id = data["_id"].stringValue
        let color = data["avatarColor"].stringValue
        let avatarName = data["avatarName"].stringValue
